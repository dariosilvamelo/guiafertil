...
class Ui_succession_planting(object):
    ...
    def retranslateUi(self, succession_planting):
        ...
        self.btn_confirm.setText(QCoreApplication.translate("succession_planting", u"Confirmar", None))
        self.btn_cancel.setText(QCoreApplication.translate("succession_planting", u"Cancelar", None))
    # retranslateUi
