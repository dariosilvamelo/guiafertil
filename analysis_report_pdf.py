...
class AnalysisReportPdf:
    ...
    def generate_report(self):
        ...
        for index, field in self.data.iterrows():
            ...
            self.c.drawString(self.mm_to_point(self.columns[7]), self.mm_to_point(self.line_position-self.line_spacing), str(field['pre_sowing_N_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[8]), self.mm_to_point(self.line_position-self.line_spacing), str(field['pre_sowing_P2O5_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[9]), self.mm_to_point(self.line_position-self.line_spacing), str(field['pre_sowing_K2O_analysis_kg']))
            ...
            self.c.drawString(self.mm_to_point(self.columns[7]), self.mm_to_point(self.line_position-self.line_spacing), str(field['seeding_N_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[8]), self.mm_to_point(self.line_position-self.line_spacing), str(field['seeding_P2O5_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[9]), self.mm_to_point(self.line_position-self.line_spacing), str(field['seeding_K2O_analysis_kg']))
            ...
            self.c.drawString(self.mm_to_point(self.columns[7]), self.mm_to_point(self.line_position-self.line_spacing), str(field['top_dressing_N_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[8]), self.mm_to_point(self.line_position-self.line_spacing), str(field['top_dressing_P2O5_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[9]), self.mm_to_point(self.line_position-self.line_spacing), str(field['top_dressing_K2O_analysis_kg']))
            ...
            self.c.setFont(self.value_font_type, self.font_size)
            self.c.drawString(self.mm_to_point(self.columns[2]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_zn_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[3]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_b_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[4]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_cu_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[5]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_mn_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[6]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_mo_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[7]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_co_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[8]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_ca_analysis_kg']))
            self.c.drawString(self.mm_to_point(self.columns[9]), self.mm_to_point(self.line_position-self.line_spacing), str(field['micro_s_analysis_kg']))
