...
class SupportVectors():
    ...
    def create_regressor(self):
        ...
        if self.register.cbx_kernel.currentText() == 'poly':
            regressor = SVR(kernel=self.register.cbx_kernel.currentText(), degree = int(self.register.edt_degree.text()))
        else:
            regressor = SVR(kernel=self.register.cbx_kernel.currentText())
