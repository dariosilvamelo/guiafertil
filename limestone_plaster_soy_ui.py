...
class Ui_limestone_plaster_soy(object):
    def setupUi(self, limestone_plaster_soy):
        ...
        limestone_plaster_soy.resize(288, 114)
    ...
    def retranslateUi(self, limestone_plaster_soy):
        ...
        self.btn_confirm.setText(QCoreApplication.translate("limestone_plaster_soy", u"Confirmar", None))
        self.btn_cancel.setText(QCoreApplication.translate("limestone_plaster_soy", u"Cancelar", None))
