...
class Ui_bean_technology(object):
    ...
    def retranslateUi(self, bean_technology):
        ...
        self.btn_confirm.setText(QCoreApplication.translate("bean_technology", u"Confirmar", None))
        self.btn_cancel.setText(QCoreApplication.translate("bean_technology", u"Cancelar", None))
    # retranslateUi
