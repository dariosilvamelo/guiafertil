...
class Analysis():
   ...
   def predict_productivity(self):
      ...
      """
      if self.register.cbx_planting_system_analysis.currentText()=='CONVENCIONAL - IRRIGADO':
         dataset.append(float(1.0))
         dataset.append(float(0.0))
         dataset.append(float(0.0))
         dataset.append(float(0.0))
      elif self.register.cbx_planting_system_analysis.currentText()=='CONVENCIONAL - SEQUEIRO':
         dataset.append(float(0.0))
         dataset.append(float(1.0))
         dataset.append(float(0.0))
         dataset.append(float(0.0))
      elif self.register.cbx_planting_system_analysis.currentText()=='PLANTIO DIRETO - IRRIGADO':
         dataset.append(float(0.0))
         dataset.append(float(0.0))
         dataset.append(float(1.0))
         dataset.append(float(0.0))
      elif self.register.cbx_planting_system_analysis.currentText()=='PLANTIO DIRETO - SEQUEIRO':
         dataset.append(float(0.0))
         dataset.append(float(0.0))
         dataset.append(float(0.0))
         dataset.append(float(1.0))

      dataset.append(validates_float(self.register.edt_altitude_analysis.text()))
      dataset.append(validates_float(self.register.edt_minimum_temperature_analysis.text()))
      dataset.append(validates_float(self.register.edt_maximum_temperature_analysis.text()))
      dataset.append(validates_float(self.register.edt_rain_vegetative_analysis.text()))
      dataset.append(validates_float(self.register.edt_rain_reproductive_analysis.text()))
      #dataset.append(validates_float(self.register.edt_ph_H2O_analysis.text()))
      dataset.append(validates_float(self.register.edt_ph_CaCl2_analysis.text()))
      dataset.append(validates_float(self.register.edt_clay_analysis.text()))
      dataset.append(validates_float(self.register.edt_MO_analysis.text()))
      dataset.append(validates_float(self.register.edt_CO_analysis.text()))
      dataset.append(validates_float(self.register.edt_K_cmolc_analysis.text()))
      dataset.append(validates_float(self.register.edt_Ca_analysis.text()))
      dataset.append(validates_float(self.register.edt_Mg_analysis.text()))
      dataset.append(validates_float(self.register.edt_Al_analysis.text()))
      dataset.append(validates_float(self.register.edt_H_Al_analysis.text()))
      dataset.append(validates_float(self.register.edt_P_meh_analysis.text()))
      #dataset.append(validates_float(self.register.edt_P_rem_analysis.text()))
      #dataset.append(validates_float(self.register.edt_Na_analysis.text()))
      dataset.append(validates_float(self.register.edt_K_mg_analysis.text()))
      dataset.append(validates_float(self.register.edt_S_SO4_analysis.text()))
      dataset.append(validates_float(self.register.edt_B_analysis.text()))
      dataset.append(validates_float(self.register.edt_Cu_analysis.text()))
      dataset.append(validates_float(self.register.edt_Fe_analysis.text()))
      dataset.append(validates_float(self.register.edt_Mn_analysis.text()))
      dataset.append(validates_float(self.register.edt_Zn_analysis.text()))
      dataset.append(validates_float(self.register.edt_pre_sowing_N_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_pre_sowing_P2O5_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_pre_sowing_K2O_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_planting_fertilizer_N_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_planting_fertilizer_P2O5_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_planting_fertilizer_K2O_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_top_dressing_N_analysis_KG.text()))
      #dataset.append(validates_float(self.register.edt_top_dressing_P2O5_analysis_KG.text()))
      dataset.append(validates_float(self.register.edt_top_dressing_K2O_analysis_KG.text()))
      self.register.predict_productivity.predictive_attributes.clear()
      self.register.predict_productivity.predictive_attributes.append(dataset)
      self.register.predict_productivity.exec()
