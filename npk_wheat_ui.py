...
" de manuten\u00e7\u00e3o (o sistema ajustar\u00e1 automaticamente). ", None))
        ...
        self.btn_confirm.setText(QCoreApplication.translate("npk_wheat", u"Confirmar", None))
        self.btn_cancel.setText(QCoreApplication.translate("npk_wheat", u"Cancelar", None))
    # retranslateUi
