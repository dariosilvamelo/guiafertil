...
class Ui_npk_wheat(object):
    def setupUi(self, npk_wheat):
        ...
        self.cbx_phosphate_fertilizer.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.ckb_previous_culture_corn.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.ckb_limestone_recommendation.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.ckb_plaster_recommendation.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.cbx_cultivar_size.setCursor(QCursor(Qt.PointingHandCursor))
